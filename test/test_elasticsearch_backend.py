...
class ElasticsearchSearchBackendTestCase(TestCase):
    ...
    def test_search(self):
        ...
        self.assertEqual(sorted(results['facets']['fields']['name']), sorted([('daniel3', 1), ('daniel2', 1), ('daniel1', 1)]))
...
class LiveElasticsearchMoreLikeThisTestCase(TestCase):
    ...
    def test_more_like_this(self):
        ...
        if elasticsearch.__version__[0] < 2:
            ...
            self.assertEqual(mlt.count(), 12)
            self.assertEqual(set([result.pk for result in mlt]), set([u'10', u'5', u'1', u'2', u'21', u'2', u'4', u'6', u'23', u'9']))
        ...
        if elasticsearch.__version__[0] < 2:
            ...
            self.assertEqual(alt_mlt.count(), 18)
            self.assertEqual(set([result.pk for result in alt_mlt]), set([u'2', u'3', u'4', u'6', u'8', u'16', u'17', u'19', u'21']))
        ...
        if elasticsearch.__version__[0] < 2:
            ...
            self.assertEqual(alt_mlt_with_models.count(), 12)
            self.assertEqual(set([result.pk for result in alt_mlt_with_models]), set([u'10', u'5', u'1', u'2', u'21', u'2', u'4', u'6', u'23', u'9']))
        ...
        if hasattr(MockModel.objects, 'defer'):
            ...
            if elasticsearch.__version__[0] < 2:
                ...
                self.assertEqual(deferred.count(), 12)
                self.assertEqual(set([result.pk for result in deferred]),
                                 set([u'10', u'5', u'1', u'2', u'21', u'2', u'4', u'6', u'23', u'9']))
...
class LiveElasticsearchAutocompleteTestCase(TestCase):
    ...
    def test_autocomplete(self):
        ...
        # Test multiple words.
        autocomplete_2 = self.sqs.autocomplete(text_auto='your mod').order_by('-_score')
